...
// this version, we will calculate the uncertainty of anisotropy------	
  ...
  //---end of reading information
	...
	if(RAflag==1){
		...
		compute_dispM_writeASC(parabest,paraP,modelP,PREM,inpamp,inpphi,Nprem,flagupdaterho,Rsurflag,Lsurflag,flagreadVkernel,flagreadLkernel,AziampRsurflag,AziampLsurflag,AziphiRsurflag,AziphiLsurflag,dirlay,str);
	}
