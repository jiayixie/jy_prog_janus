...
set id = ${vv}_Tibet_v1_laytheta.20disc.XYdip.aug11.vpvs.3.AZmat4.5perc.RALT10 #May 4 2016
...
if ( 1 == 1 )then
	...
	echo $dirout
	$exe/invTibet_posRALT10gp12SP_nosign_20disc_XYdip_vpvs $finponm $dirout $fstartmod $dirRphvel $dirRgpvel $dirLphvel $dirLgpvel $fparanm $flagreadVkernel $num_thread
	#exit
