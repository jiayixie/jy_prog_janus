...
c    15 DEC 2012 - fixed  do pltm(  by removing the first unused argument
c
c-----
...
c-----
        call pltm(nx,xc,zc,nc,ii,srcx,srcz,mlyr,
...
c-----
 ...
 100    continue
        ...
        subroutine pltm(nx,xc,zc,nc,ii,srcx,srcz,mlyr,
