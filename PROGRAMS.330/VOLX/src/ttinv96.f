...
c-----
        ...
        if(.not.(ext)) kerr=ssytem('ttinvpr96')
c-----
...
C                call ssamat(id,nfilt,i,wref,invcsl,nf1,
C     1              invdep,lstinv,sigv,sigts)
                call tamat(id,nfilt,i,wref,invcsl,nf1,
...
c-----
C            call ssamat(id,nfilt,i,wref,invcsl,nf1,invdep,
C     1          lstinv,sigv,sigts)
