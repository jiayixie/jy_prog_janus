...
#	print line,l1[5]
    ...
    tmag = float(l1[9])
    if tmag < mag_cri or tdist < 111*(deg_min-Toedge) or tdist > 111*(deg_max+Toedge): #throw some evt according to its dist to station centra
	continue;
    ya=l1[1][0:4]
    mon=l1[1][5:7]
    da=l1[1][8:10]
