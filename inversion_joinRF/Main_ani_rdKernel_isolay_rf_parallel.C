...
{
int npoint,Rsurflag,Lsurflag,Rmonoc,Lmonoc,PosAnic,iitercri1,iitercri2,ijumpcri1,ijumpcri2,RFflag;
...
sprintf(dirlay,argv[2]);
  ...
  Lsurflag=1;
  RFflag=0; // RFflag==1, read and cpt receiver function.  
  ...
  while(1){
    ...
    sprintf(modnm,"%s/%s.mod1",argv[3],nodeid);
    //sprintf(modnm,"%s",argv[3]);
    //----- receiver function data----
    sprintf(rfnm,"%s/%s.RF",argv[12],nodeid);
