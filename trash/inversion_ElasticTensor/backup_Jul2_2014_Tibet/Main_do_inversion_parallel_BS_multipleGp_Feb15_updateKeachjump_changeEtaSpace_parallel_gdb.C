...
#include"CALforward_Mineos_readK_parallel_BS_newV2L_parallel.C"
#include "./ASC_rw.C"
...
//#include "para_avg_multiple_gp_v3.C" // this is BUG in this code, USE v4!!
...
sprintf(dirlay,".");
//sprintf(dirlay,"/lustre/janus_scratch/jixi7887/US/inv_ET_BS/inv_v14.2_upKjmp_2%_newV2L_Avg_EtaSpc1.1_Apr25_vpvsCM1.4/V15A_-112.0_36.0_inv_v14.2_upKjmp_2%_newV2L_Avg_EtaSpc1.1_Apr25_vpvsCM1.4");
  //----------------PARAMETERS-----------------------------------------
  ...
  */
  ///*
  sprintf(inponm,"point.txt");
  sprintf(Rphindir,"/projects/jixi7887/work/US/inv_ET_BS/data_disp_Feb9_scaleUncisoANDazi/phvel_Ray_cutted");
  sprintf(Rgpindir,"/projects/jixi7887/work/US/inv_ET_BS/data_disp_Feb9_scaleUncisoANDazi/phvel_Ray_cutted");
  sprintf(Lphindir,"/projects/jixi7887/work/US/inv_ET_BS/data_disp_Feb9_scaleUncisoANDazi/phvel_Lov");
  sprintf(Lgpindir,"/projects/jixi7887/work/US/inv_ET_BS/data_disp_Feb9_scaleUncisoANDazi/phvel_Lov");
  sprintf(fparanm,"/projects/jixi7887/work/US/inv_ET_BS/para_BS_CstMat_v14.2.txt");
  flagreadVkernel=1;
  int num_thread=100;
  //*/
...
sprintf(tmpstr,"if [ ! -d %s/binmod ]; then mkdir %s/binmod; fi",dirlay,dirlay);
  ...
  while(1){
    ...
    //sprintf(modnm,"/projects/jixi7887/work/US/inv_ET_BS/data_mod_Jan3_CstMat/V15A.mod");
    sprintf(modnm,"./V15A.mod");
    //---------------------------------------------------------
    initmodel(model0);
    initmodel(modelref);
...
*/
  ...
  /* I've put all the disp computation and writting into CALavg_getposteria_v8.C
