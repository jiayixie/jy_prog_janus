...
awk '{print $1,$2,$3}' /data/jiayi/work/WUS/irisInfo/station_combine.lst | sort -d  > temp_sta.lst
echo "doing rotation..." >> process.txt
#/home/jiayi/progs/jy/rotate_filp/lfrotate_all_64  temp_sta.lst ./stack_cv_jy_fc_v3
...
rm -f path_without_pred_disp.txt
foreach ch ( TT )
/home/jiayi/progs/jy/aftan/with_jump_no_amp/aftani_c_pgl_cor_love_with_pred_model Infosaclst_eT_snr5_T35_60_${ch}.txt path_without_pred_disp.txt
end
