...
# this version, is for the v13.8 para, which has two para for sediment. so the para # for theta,phi would change
...
#fpoint = "%s/point_info/point_info_closestnm_Hsed_1deg.txt"%(indir)
...
paraidlst=[7,8,77,78] #theta,phi in the crust, and theta, phi in the mantle #sed case
