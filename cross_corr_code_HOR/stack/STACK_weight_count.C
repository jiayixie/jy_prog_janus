...
// this version could be modified by adding the user8 together. user8 was written in the justcor code, it stores the days that have been added.
...
//    fprintf (stderr,"reverse!!!!!\n");
  ...
  shd->user4=Ncount; // count months
  shd->user8=NN; //count days
  return 1;
  }
