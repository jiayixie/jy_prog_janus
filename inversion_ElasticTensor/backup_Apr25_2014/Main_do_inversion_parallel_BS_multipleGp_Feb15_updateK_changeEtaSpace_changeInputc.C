...
// this version, use CALpara_isolay_BS_newV2L_changeEtaSpace.C, which require eta0<=X (e.g.,1.1)
// this version, use CALmodel_LVZ_ET_BS_changeInputc.C change the input model
...
#include "CALmodel_LVZ_ET_BS_changeInputc.C"
