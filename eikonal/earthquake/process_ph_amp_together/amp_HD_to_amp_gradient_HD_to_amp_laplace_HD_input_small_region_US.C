...
//  y0=25;
  ...
  for(;;)
      ...
      if(access(buff1, F_OK) == 0)
	{
      ...
      sprintf(buff1,"%s_v2_am.HD",event_name);
      ...
      for(;;)
	{
      ...
      fclose(fgradx);
      fclose(fgrady);
      sprintf(buff1,"/home/jixi7887/progs/jy/eikonal/earthquake/C_plot_travel %s_am_gradx.txt_v2 %g %g %g %g",event_name,x0,x1,y0,y1);
      system(buff1);
      sprintf(buff1,"/home/jixi7887/progs/jy/eikonal/earthquake/C_plot_travel %s_am_grady.txt_v2 %g %g %g %g",event_name,x0,x1,y0,y1);
      system(buff1);
