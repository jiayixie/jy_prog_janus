...
// this version, use CALinv_isolay_rf_parallel_saveMEM_BS_updateK_parallel.C, which updated the Vkernel&Lkernel during the inversion and parallel the inversin part
// this version also use CALforward_Mineos_readK_parallel_BS_newV2L_parallel.C
...
#include "CALinv_isolay_rf_parallel_saveMEM_BS_updateK_parallel.C"
...
sprintf(dirlay,argv[2]);
  ...
  iitercri1=1000;//12000 (mod1, 1cstlay)
  iitercri2=15000;
