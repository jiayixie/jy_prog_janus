...
c        parameter (eta=0.4)
c        parameter (eta=0.9)
c        parameter (eta=0.866975)
        parameter (eta=0.737630)
...
c symmetry axis.
        ...
        write(*,*) "C11=",a(3,3,3,3)," C33=",a(1,1,1,1)
        write(*,*) "C12=",a(3,3,2,2)," C13=",a(3,3,1,1)
        write(*,*) "C44=",a(1,3,1,3)," C66=",a(2,3,2,3)
        write(*,*) "normalized by rho = ",rho
