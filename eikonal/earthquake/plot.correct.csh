...
set exe = /home/jixi7887/progs/jy/eikonal/earthquake
set input = $1
set outps = $input.ps
...
set bb = `python $exe/compute_mean_std.rs.py ph.dat 3 | awk '{print $1-2*$2}'`
set ee = `python $exe/compute_mean_std.rs.py ph.dat 3 | awk '{print $1+2*$2}'`
...
set bb = `python $exe/compute_mean_std.rs.py amp.dat 3 | awk '{print $1-3*$2}' | awk '{if ($1<0) print 0; else print $1;}'`
set ee = `python $exe/compute_mean_std.rs.py amp.dat 3 | awk '{print $1+3*$2}'`
