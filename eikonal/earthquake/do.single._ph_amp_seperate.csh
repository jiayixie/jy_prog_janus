set sh_dir = /home/jixi7887/progs/jy/eikonal/earthquake
set fsta1 =  /home/jixi7887/work/US/irisInfo/from_cv/2010.events.lst 
...
set event = 20100511121746 #20101109111652
#set inf = 20061225200058_3pi.${per}
set inf = $event.${per}

awk '{if ($14>'$snr1' && $15 > '$snr2' && $10>0) print $7,$8,$11,$9,$13,$3,1; else print $7,$8,$12,$10,$13,$3,0;}' /lustre/janus_scratch/jixi7887/US/eikonal_eqk/2010/$inf > $inf.input
