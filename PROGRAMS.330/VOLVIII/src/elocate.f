...
c    dimension will give a larger errelpe
c----
  ...
  990   continue 
   ...
   22 format(1x,a6,1x,a2,f7.2,2f5.0,1x,f20.3,1x,f10.2,2x,i1,1x, 
     1  a1,a2,a8,f5.2)
        ...
        call etoh(t0,date,str,doy)
c-----
c    invoke errelpe once more to get printed output
c-----
        call  errelp(sum3,co(1,1),co(1,2),co(2,2),theta,l1,l2,
     1      verbose)
        if(verbose)then
...
c-----
        ...
        integer i, ni, ang
        double precision c,s,t1,t2,t3,xp,zp
...
c                minor arc 
              ...
              delkm = a * ellip(e2p, (te)/degrad,180.0d+00) 
     1                  + a * ellip(e2p, -180.0d+00,(ts)/degrad) 
       endif
       return
       end
