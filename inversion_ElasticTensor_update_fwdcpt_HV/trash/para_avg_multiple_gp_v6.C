...
//--------------------------
int cs2ap_v2(double Ac,double As, double &amp,double &phi){
...
//------------------
int get_peak(vector<double> vlst, double &pk,double T){
//-- compute the peak value; bin the list and get the value correlated with most data
  double dv;
...
//  --------------------------
int convert_AZpara(vector<paradef> &paralst,vector<int> AZcosidlst, vector<int> idlst, int Ngood){
  ...
  double T,AZcos,AZsin,ang,amp,pk;
