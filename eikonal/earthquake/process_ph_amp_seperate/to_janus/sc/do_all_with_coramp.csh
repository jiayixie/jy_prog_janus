...
#set evlst = /home/jiayi/work/SC/run_eikonal/evt.txt
	...
	rm -f slow_azi_*
	/home/jiayi/progs/jy/eikonal/earthquake/travel_time_to_slow_map_v4_v3_v2to10_270_noampHD_dist $evlst  $per $dist_cri
	echo 'begin to run slow map to iso map..................'
	/home/jiayi/progs/jy/eikonal/earthquake/slow_maps_to_iso_map_ani_data_v5_n50_270_noamp $evlst  0 360 18 $per"s_iso_ani_v1"
	more ${per}s_iso_ani_v1.iso | awk '{if($3>0)print $0}' > ${per}s_iso_ani_v1.1.iso 
	echo 'begin to run amp to amp grad laplace ....'
	/home/jiayi/progs/jy/eikonal/earthquake/amp_HD_to_amp_gradient_HD_to_amp_laplace_HD event_lst $per
	echo 'begin to run slow laplace to iso map ani ........'
	/home/jiayi/progs/jy/eikonal/earthquake/slow_laplace_maps_to_iso_map_ani_data_v5_n50_270_noamp_scale event_lst 0 360 18 $per"s_laplace_iso_ani_v1" 1
