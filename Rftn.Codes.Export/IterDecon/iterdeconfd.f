...
c
******************************************************************************
c     Added by Jiayi Oct.28 2011
c     The NPTS of the sac files cannot be larger than MAXPTS/2 (which is 4096 here)
c
      integer MAXPTS, MAXG
