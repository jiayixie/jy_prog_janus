...
//--------------------------
vector<int> para_avg_multiple_gp(int idphi,int idphiM, vector<paradef> &paralst, vector<paradef> &parabestlst, vector<paradef> &paraavglst, vector<paradef> &parastdlst, vector<vector<int> > &idlstlst, int flag, double &pkC){
  ...
  */
  ...
  NgpM=0;
  seperate_gp(philstM,NgpM,pkM,indexflaglstM);
  for(i=0;i<Ngood;i++){
	k=idlst[i];
