...
c	     print *, 'begin read grid file--test'
...
c	     print *, 'do path--test',elon,elat,slon,slat
...
C       	      write(*,36) iev(j),ista(j),nper,evnam(j),'  ',stnam(j), 
...
36          format(2i5,i3,a16,a2,a10,4f9.3)
...
C#####################################################################
     ...
     1      stalon,stnam,iev,evlat,evlon,evnam,npath)
	    ...
	    parameter (N = 1400000)
C----       character*10 stnam(N)
            character*10 stnam(N)
...
4           do j=1,2000000
     ...
     1               ," check"
            enddo
999         close(7)
 2	  format(2i5,1x,a16,1x,a10,4(f10.3))
